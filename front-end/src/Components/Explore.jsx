...
//             <h1 className="orangeText">Our Value</h1> <br/><span>Value we Give to you<br/></span>
        ...
        <div className="paddings innerWidth flexCenter v-container">
          ...
          <div className="flexColStart v-right">
            ...
            >
              {data.map((item, i) => (
                <AccordionItem
                  className={`accordionItem ${activeClassName}`} // Used activeClassName instead of className
                  key={i}
                  uuid={i}
                >
                  <AccordionItemHeading>
